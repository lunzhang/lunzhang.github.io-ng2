export class Swords {
    static swords = [{name:'Khopesh',region:'Bronze Age',country:'Egypt',link:'www.en.wikipedia.org/wiki/Khopesh', img:'https://upload.wikimedia.org/wikipedia/commons/3/38/Khopesh.jpg'},
...
for(var i = 0; i <$('#mw-content-text').find('ul').find('li').find('a').length;i++){
console.log($($('#mw-content-text').find('ul').find('li').find('a')[i]).attr('title'));
}
